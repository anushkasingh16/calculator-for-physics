...
def find_displacement():
     ...
     if first_var_choice == 'Y':
         final_velocity = int(input('\nEnter final velocity: '))
         result = (math.pow(final_velocity,2)-math.pow(initial_velocity,2))/(2*acceleration)
     elif first_var_choice == 'N':
         time_taken = int(input('\nEnter time taken: '))
         result = initial_velocity*time_taken + 0.5*acceleration*math.pow(time_taken,2)
     else:
         print('\nIncorrect choice selected.')
         return
     clear()
     print('\nThe DISPLACEMENT is : ',result)
     return result
...
def find_time_taken():
     ...
     if first_var_choice == 'Y':
         ...
         final_velocity = find_final_velocity()
         result = (final_velocity-initial_velocity)/acceleration
     else:
         print('\nIncorrect choice selected.')
         return
     clear()
     print('\nThe TIME TAKEN is : ',result)
     return result
